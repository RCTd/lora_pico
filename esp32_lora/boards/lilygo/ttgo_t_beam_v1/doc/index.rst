.. zephyr:board:: ttgo_t_beam

Overview
********

The Lilygo TTGO T-Beam is a development board for LoRa applications based on the ESP32-PICO-D4.
...
of the Lilygo TTGO T-Beam board.
...
Before powering up your Lilygo TTGO T-Beam, please make sure that the board is in good
...
.. zephyr-app-commands::
   ...
   :board: ttgo_t_beam/esp32/procpu
   :goals: build
   :west-args: --sysbuild
   :compact:
...
The usual ``flash`` target will work with the ``ttgo_t_beam`` board target.
...
The default baud rate for the Lilygo TTGO T-Beam is set to 1500000bps. If experiencing issues when flashing,
...
Lilygo TTGO T-Beam debugging is not supported due to pinout limitations.

Related Documents
*****************
- `Lilygo TTGO T-Beam schematic <https://github.com/Xinyuan-LilyGO/LilyGo-LoRa-Series/blob/master/schematic/T3_V1.6.1.pdf>`_ (PDF)
- `Lilygo TTGO T-Beam documentation <https://www.lilygo.cc/products/lora3>`_
